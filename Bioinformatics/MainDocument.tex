...
\author[G. Derevyanko \textit{et~al}.]{Georgy Derevyanko\,$^{\text{\sfb 1,}*}$, Co-Author\,$^{\text{\sfb 2}}$ and Guillaume Lamoureux\,$^{\text{\sfb 2,}*}$}
\address{$^{\text{\sf 1}}$Department of chemistry and biochemistry, Concordia University, Montreal, Post Code, Canada and \\
...
\textbf{Contact:} \href{georgy.derevyanko@gmail.com}{georgy.derevyanko@gmail.com}\\
