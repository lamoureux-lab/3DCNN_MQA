...
cover the same range of sequence lengths (SI Fig. 1)}. 
...
X, H, T, and F). 
%
\tchanged{Another representation of the overlap between the test and training sets is shown on SI Figure 2.}
