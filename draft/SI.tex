...
\begin{figure}[H]
    ...
    \makebox[0pt][c]{
    \hskip-\footskip
    \includegraphics[width=0.8\paperwidth]{Fig/CASP11Stage1_SCWRL_sFinal_funnels.png}
    \hskip\headheight
    }
...
\begin{figure}[H]
    ...
    \makebox[0pt][c]{
    \hskip-\footskip
    \includegraphics[width=0.8\paperwidth]{Fig/CASP11Stage2_SCWRL_sFinal_funnels.png}
    \hskip\headheight
    }
