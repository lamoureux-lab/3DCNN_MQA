...
\begin{center}
%
%%% GL: References numbers are not in the correct order (should be [1]
%%% and [2] instead of [2] and [1]).
...
%%% GL: Table S3 should either be mentioned in the main text or be
%%% removed. Isn't this information already contained in Figure 1,
%%% though?
%
%%% GL: What about T0797? It's blank in Figure 1 but is not present in
%%% that table.
%
\begin{table}[H]
\begin{center}
...
%%% GL: Why writing the stride as 1x1x1? It's enough to write 1.
\begin{table}[H]
\begin{center}
%
...
%%% GL: This should be referenced to in the main text!!!
...
The loss function is optimized using the Adam algorithm \ref{???},
...
%%% GL: This figure should be bigger: The text is very hard to read.
%
%%% GL: Also: Is there a way to not show the last panel? (which
...
%%% GL: This figure is not referenced in the main text!!!
\begin{figure}[H]
    \centering
...
%%% GL: Move this text in the caption of Figure S5. Simplify if
%%% necessary. We do not want ``floating'' text in the Supporting
%%% information.
%
...
%%% GL: What do you mean by ``to do on server''?
...
%
%%% GL: This reference to Table ??? does not compile... Just hardcode it.
...
%%% GL: Move this figure up so that the caption is not below the page number!!!
\begin{figure}[H]
    \centering
    \makebox[0pt][c]{
    \hskip-\footskip
...
%%% GL: Add a caption to GradCAMTable!!!
