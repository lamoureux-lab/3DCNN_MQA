...
\begin{figure}[H]
    ...
    model parameters can be found in Supplementary Information Table 4.}
...
examples used to estimate the gradient (``batch''):
$$
...
the input domain with the stride $l$ (distance between two consequtive cubes along one dimension).
The output size is then approximately $l$ times smaller than the input data bounding box.
All three ``MaxPool'' layers of the model (Fig.\ \ref{Fig:CNNModel}) use $d=3$ and $l=2$.
