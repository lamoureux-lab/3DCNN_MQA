...
net:add(nn.VolumetricBatchNormalization(32))
net:add(nn.ReLU())
net:add(nn.VolumetricMaxPooling(3,3,3,2,2,2))     
...
-- model:load_model('../../models/QA_bn_gdt_ts_4_ranking_model_8_CASP_SCWRL/models/epoch100')
-- model:load_model('../../models/train_load_test_ranking_model_8_nobn_CASP_SCWRL/models/epoch1')
