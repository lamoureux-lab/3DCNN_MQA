...
training_dataset = cDatasetBase.new(optimization_parameters.batch_size, input_size, true, true, 1.0)
training_dataset:load_dataset('/home/lupoglaz/ProteinsDataset/3DRobotTrainingSet/Description','training_set.dat')
training_logger = cTrainingLogger.new('Test', modelName, '3DRobotTrainingSet', 'training')

validation_dataset = cDatasetBase.new(optimization_parameters.batch_size, input_size, false, false, 1.0)
validation_dataset:load_dataset('/home/lupoglaz/ProteinsDataset/3DRobotTrainingSet/Description','validation_set.dat')
validation_logger = cTrainingLogger.new('Test', modelName, '3DRobotTrainingSet', 'validation')
